 ...
 * code.  This is a prototype for a Xen 9p transport driver.  
 *
 *  Copyright (C) 2015 Linda Jacobson
 *
 *  Copied with modifications from the virtio 9p transport driver
...
/**
 * p9_xen_probe - probe for existence of 9P virtio channels
 *                initialize 9p "device"
 *                either replaces, calls or is called by probe in p9_front.c
